...
"""
    mutualinfo(e::Entropy, x, y, est; base = 2, q = 1)
...
function mutualinfo(e::Entropy, x::Vector_or_Dataset, y::Vector_or_Dataset, est)
...
mutualinfo(e, x::Vector_or_Dataset, y::Vector_or_Dataset, est; base = 2) =
    mutualinfo(Shannon(; base), x::Vector_or_Dataset, y::Vector_or_Dataset, est)




"""
    conditional_mutualinfo(e::Entropy, x, y, z, est; base = 2, q = 1)
...
"""
function conditional_mutualinfo(e::Entropy, x::Vector_or_Dataset, y::Vector_or_Dataset,
        z::Vector_or_Dataset, est)
    mutualinfo(e, x, Dataset(y, z), est) - mutualinfo(e, x, z, est)
end

conditional_mutualinfo(x::Vector_or_Dataset, y::Vector_or_Dataset,
        z::Vector_or_Dataset, est; base = 2) =
    conditional_mutualinfo(Shannon(; base), x::Vector_or_Dataset, y::Vector_or_Dataset,
        z::Vector_or_Dataset, est)
