...
te_b2 = @test transferentropy(pts, vars, RectangularBinning(0.2), VisitationFrequency(b = 2))
te_b10 = @test transferentropy(pts, vars, RectangularBinning(0.2), VisitationFrequency(b = 2))
@test te_b2 != te_b10
